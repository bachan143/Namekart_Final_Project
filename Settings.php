                                                ...
                                                <div class="row" id="platform-setting">
                                                  <div class="col-m-12">
                                                    <form class="" action="#" method="post">
                                                      ...
                                                      <button type="button" name="button" class="btn  btn-lg btn-block" style="background:#0d78a9;color:white;">SAVE</button>
                                                      ...
                                                      <div class="col-m-12"  id="platform-setting1">
                                                         <form class="" action="#" method="post">
                                                           <div class="form-group">
                                                             ...
                                                             <button type="button" name="button" class="btn  btn-lg btn-block w-50" style="background:#0d78a9;color:white;">Save Change</button>
